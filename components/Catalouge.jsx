...
const ItemProduct = (props) => {
  return (
    <div className="relative">
      <div className="mb-5">
        <Image src={props.image} width={484} height={704} className="rounded-xl" alt="" />
      </div>
...
export default function Catalogue() {
  return (
    <div className=" container mx-auto my-10 pt-32 pb-12">
      ...
      <div className="flex flex-col md:flex-row lg:flex-row xl:flex-row lg:space-x-5 cursor-pointer">
