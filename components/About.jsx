...
export default function About() {
  return (
    <div className="container mt-28 p-9 shadow-top shadow-bottomy
     shadow-xl">
      <div className="flex flex-wrap md:pt-12 md:pb-12 lg:pt-12 ">
        <div class="w-full self-center px-4 lg:w-1/2">
          <h1 class="mt-1 block text-4xl font-bold lg:text-5xl text-primary font-poppinsy">What is CatPedia?
          </h1>
          <div class="w-full md:w-1/3 md:mx-12 lg:w-1/2 h-1 mt-1 mx-auto rounded-full bg-primary"></div>
        </div>
        <div class="w-full mt-8 lg:mt-0  self-center px-4 lg:w-1/2 ">
          <p class="mb-10 font-medium leading-relaxed text-slate-500">
